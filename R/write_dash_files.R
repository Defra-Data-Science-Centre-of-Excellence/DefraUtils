#' @title Write files to a DASH volume
#'
#' @author Josh Moatt
#'
...
#'   `dash_volume_write` which can be used to save previously created files to
...
#'   passed to the general function `dash_volume_write` and the file is written
