test_that("Git config commands are constructed correctly", {
  ...
  mockery::stub(
    connect_github_pat, "gitcreds::gitcreds_set", function() NULL
  )
  mockery::stub(
    connect_github_pat, "credentials::set_github_pat", function() NULL
  )

  # Stub cli alerts
  mockery::stub(
    connect_github_pat, "cli::cli_alert_success", function(...) NULL
  )
  mockery::stub(
    connect_github_pat, "cli::cli_alert_warning", function(...) NULL
  )
...
test_that("Does not duplicate credentials line in .Rprofile", {
  ...
  mockery::stub(
    connect_github_pat, "system", function(cmd) {
      return(0)
    }
  )
  mockery::stub(
