...
The package is under active development and we will highlight chnages to users.
...
Although the package originated within Farming Stats, it is designed as a resource for all analysts across Defra and it is under active development. Therefore, we welcome contributions, bug reports, and suggestions for improvement from all users.
...
If you would like to join the team managing the `DefraUtils` package and repo, please email Farming Stats at [AUK_stats_update@defra.gov.uk](mailto: AUK_stats_update@defra.gov.uk).
